...
import { TesterComponent } from '../feature-modules/admin/manage-assessment/tester.component';
export const adminRouterConfig = [
    ...
    { path: 'admin/manage-assessment/test', component:TesterComponent, canActivate: [LoginGuard, AuthorizeGuard] },
