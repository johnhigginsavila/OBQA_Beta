...
export class ClassService {
    ...
    private classFindUrl:string = 'class';
    private classFindProgramUrl:string = 'class/findprogram';
    private classFindOneUrl:string = 'class/:id';
    private classCreateUrl:string = 'class/create';
    private jwt:string;
