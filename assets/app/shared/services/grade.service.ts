...
export class GradeService {
    ...
    private jwt:string;
    private getGradeStatusSummaryUrl:string = '/grade/statussummary';
    private getGradePerStudentUrl: string ='/grade/statusperstudent'; // students with grades sorted by program for average sopi grades
