...
export class AssessmentService {
    private assessmentFindUrl:string = 'assessment/find';
    private assessmentFindOneUrl:string = 'assessment/findOne';
    private assessmentCreateUrl:string = 'assessment/create';
    private assessmentReportSummaryUrl:string = 'obqamonitoringreport/statussummary';
    private assessmentReportPerProgramUrl:string = 'obqamonitoringreport/statusperprogram';
    private addImprovementPlanUrl:string = 'assessment/update';
    private session:ISession;
    private jwt:string;
    
    private obqaMonitoringReportUrl:string = 'obqamonitoringreport/reportperprogram';
    private obqaMonitoringCycleReportUrl:string = 'obqamonitoringreport/cyclereport';
    ...
    GetAssessmentPerProgram(program:number, cycle:number, term:number):Observable<IAssessment[]>{
        ...
        this.jwt = this.session.token;
        let headers = new Headers();
        let myprogram:number = this.session.User.program;
        headers.append('Content-Type', 'application/json');
        headers.append('Authorization','Bearer ' + this.jwt);
