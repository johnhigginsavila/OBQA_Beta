...
var HeaderComponent = (function () {
    function HeaderComponent(sessionService, formBuilder, _router) {
    ...
    /*ngOnChanges(changes:{[properkey:string]: SimpleChange}){
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Boolean)
], HeaderComponent.prototype, "allowed", void 0);
HeaderComponent = __decorate([
    core_1.Component({
        selector: 'obqa-header',
